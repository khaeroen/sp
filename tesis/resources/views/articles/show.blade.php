                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <tbody>
                                    ...
                                    <tr><th> Title </th><td> {{ $article->title }} </td></tr><tr><th> Author </th><td> {{ $article->author }} </td></tr><tr><th> Supervisor </th><td> {{ $article->supervisor }} </td></tr><tr><th> Email </th><td> {{ $article->email }} </td></tr>
                                </tbody>
                            </table>
                        </div>
