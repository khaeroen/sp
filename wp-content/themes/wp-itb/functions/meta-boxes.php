...
function oswc_featured_image_size( )
{
	...
	<p>
        <select name="Featured_Image_Size" id="Featured_Image_Size"> 
            <option value="medium" <?php selected( $size, 'medium' ); ?>><?php _e( 'Medium','itb'); ?></option> 
            <option value="small" <?php selected( $size, 'small' ); ?>><?php _e( 'Small','itb'); ?></option> 
            <option value="full" <?php selected( $size, 'full' ); ?>><?php _e( 'Full','itb'); ?></option> 
            <option value="none" <?php selected( $size, 'none' ); ?>><?php _e( 'Hidden','itb'); ?></option> 
        </select> 
	</p>
    
    <p style="border:1px solid #DDD;padding:12px;background:#FCFCFC;font-style:italic;color:#666;">
    
        <?php _e( 'These settings overwrite the site-wide settings in the theme options pages.','itb'); ?>
...
function oswc_meta_video( )
{
    ...
    <p style="border:1px solid #DDD;padding:12px;background:#FCFCFC;font-style:italic;color:#666;">
        ...
        <?php _e( 'Copy + Paste video embed code here. If you use this feature, the single post view will display the video instead of the featured image, and the rest of the site will use the featured image when displaying this post (e.g. home page and archive pages).','itb'); ?>
...
function oswc_meta_misc_page( )
{
	...
	?>
    	...
    	<div style="border:1px solid #DDD;padding:12px;background:#FCFCFC;font-style:italic;color:#666;">
            ...
            <?php _e( 'These settings overwrite the global settings in the theme options pages. Select "Null" or leave blank to defer to the global setting.','itb'); ?>
...
function oswc_meta_rating( )
{
    ...
    <p>
    	<label for="positives"><?php _e( 'Positives','itb'); ?></label> 
		<textarea class="widefat" id="Positives" name="Positives"><?php echo $positives; ?></textarea>        
	</p>
    <p>
    	<label for="negatives"><?php _e( 'Negatives','itb'); ?></label> 
    ...
    <div style="float:left;margin-right:20px;border:1px solid #CCC;background:#E3E3E3;padding:10px;display:inline-block;margin-top:10px;">    
        ...
        switch ($rating_type) {
            case 'stars': ?>
                <tr>
                <td colspan="2">
                    <b><?php _e( 'Rating','itb'); ?></b>                           
                    <p class="description"><?php _e( 'Select number of stars','itb'); ?></p>
                </td>
                </tr>
            ...
            case 'percentage': ?>
                ...
                <td colspan="2">
                    <b><?php _e( 'Rating','itb'); ?></b>                           
                    <p class="description"><?php _e( 'Enter whole numbers from 0 to 100','itb'); ?></p>
                </td>
                </tr>
                <?php foreach($meta_fields as $meta) {	
                    //make backwards compatible
            ...
            case 'number': ?>
                ...
                <td colspan="2">
                    <b><?php _e( 'Rating','itb'); ?></b>                           
                    <p class="description"><?php _e( 'Enter decimals from 0 to 10','itb'); ?></p>
                </td>
                </tr>
                <?php foreach($meta_fields as $meta) {	
                    //make backwards compatible
            ...
            case 'letter': ?>
                ...
                <td colspan="2">
                    <b><?php _e( 'Rating','itb'); ?></b>                           
                    <p class="description"><?php _e( 'Select letter grades','itb'); ?></p>
                </td>
                </tr>        
                <?php foreach($meta_fields as $meta) {	
                    //make backwards compatible
    ...
    <div style="float:left;width:380px;padding-top:25px;">
        ...
        <b><?php _e( 'Hide Rating','itb'); ?></b>                           
        <p class="description"><?php _e( 'You can post reviews that do not have ratings. If you select Hide, there will be no rating assigned to this post.','itb'); ?></p>
        <input type="radio" name="Rating" id="RatingShow" value="false" <?php checked( $ratinghide, 'false' ); ?> />
        <label for="RatingShow"><?php _e( 'Show','itb'); ?></label>
        <input type="radio" name="Rating" id="RatingHide" value="true" <?php checked( $ratinghide, 'true' ); ?> />
        <label for="RatingHide"><?php _e( 'Hide','itb'); ?></label>
        <br /><br />
        
        <?php $overviewhide = get_post_meta( $post->ID, 'Hide Overview', true ); ?>
        <b><?php _e( 'Hide Overview','itb'); ?></b>                           
        <p class="description"><?php _e( 'You can post reviews that do not have the overview section. If you select Hide, the entire overview section will not be displayed on this single review page.','itb'); ?></p>
        <input type="radio" name="Overview" id="OverviewShow" value="false" <?php checked( $overviewhide, 'false' ); ?> />
        <label for="OverviewShow"><?php _e( 'Show','itb'); ?></label>
        <input type="radio" name="Overview" id="OverviewHide" value="true" <?php checked( $overviewhide, 'true' ); ?> />
        <label for="OverviewHide"><?php _e( 'Hide','itb'); ?></label>
        <br /><br />
        
        <?php $bottomlinehide = get_post_meta( $post->ID, 'Hide Bottom Line', true ); ?>
        <b><?php _e( 'Hide Bottom Line','itb'); ?></b>                           
        <p class="description"><?php _e( 'The Bottom Line just grabs your post excerpt and displays it as the bottom line text. If you select Hide, the bottom line area will not be displayed on this single review page.','itb'); ?></p>
        <input type="radio" name="BottomLine" id="BottomLineShow" value="false" <?php checked( $bottomlinehide, 'false' ); ?> />
        <label for="BottomLineShow"><?php _e( 'Show','itb'); ?></label>
        <input type="radio" name="BottomLine" id="BottomLineHide" value="true" <?php checked( $bottomlinehide, 'true' ); ?> />
        <label for="BottomLineHide"><?php _e( 'Hide','itb'); ?></label>
        <br /><br />
        
        <?php $fullarticlehide = get_post_meta( $post->ID, 'Hide Full Article Bar', true ); ?>
        <b><?php _e( 'Hide "Full Article" Bar','itb'); ?></b>                           
        <p class="description"><?php _e( 'You can post reviews that do not have the full article bar. If you select Hide, the info bar with the "Full Article" text and the author will not be displayed on this single review page.','itb'); ?></p>
        <input type="radio" name="FullArticle" id="FullArticleShow" value="false" <?php checked( $fullarticlehide, 'false' ); ?> />
        <label for="FullArticleShow"><?php _e( 'Show','itb'); ?></label>
        <input type="radio" name="FullArticle" id="FullArticleHide" value="true" <?php checked( $fullarticlehide, 'true' ); ?> />
        <label for="FullArticlewHide"><?php _e( 'Hide','itb'); ?></label>
    </div> 
