...
if (function_exists('register_sidebar')) {
	register_sidebar(array(
		...
		'description'   => __( 'These widgets appear in the sidebar of only the front page (if you set this option in the theme options)', 'itb' ),
...
if (function_exists('register_sidebar')) {
	register_sidebar(array(
		'name' => 'Frontpage Main',
		'id'   => 'frontpage-main',
		'description'   => __( 'These widgets appear in the main content area of the front page', 'itb' ),
...
if (function_exists('register_sidebar')) {
	register_sidebar(array(
		'name' => 'Top Widget',
		'id'   => 'top-widget',
		'description'   => __( 'These widgets replace the three social links to the left of the search bar in the top menu area.', 'itb' ),
		'before_widget' => '',
		'after_widget'  => '',
		'before_title'  => '',
		'after_title'   => ''
...
if (function_exists('register_sidebar')) {
	register_sidebar(array(
		'name' => 'Signup Widget',
		'id'   => 'signup-widget',
		'description'   => __( 'These widgets replace the Get Our Newsletter signup form in the Dont Miss bar.', 'itb' ),
		'before_widget' => '',
		'after_widget'  => '',
		'before_title'  => '<h3>',
		'after_title'   => '</h3>'
...
if (function_exists('register_sidebar')) {
	register_sidebar(array(
		'name' => 'Demo Panel',
		'id'   => 'demo-panel',
		'description'   => __( 'These widgets appear in the slide-out "Demo" panel and replace all the demo content. There is no styling here, just an area for you to put in your custom HTML via a text widget.', 'itb' ),
		'before_widget' => '',
		'after_widget'  => '',
		'before_title'  => '',
		'after_title'   => ''
...
if (function_exists('register_sidebar')) {
	register_sidebar(array(
		...
		'description'   => __( 'These widgets appear in the sidebar of all regular single posts (depending on settings in the theme options)', 'itb' ),
		'before_widget' => '<div class="widget-wrapper"><div class="widget">',
		'after_widget'  => '</div></div>',
		'before_title'  => '<div class="section-wrapper"><div class="section">',
		'after_title'   => '</div></div>'
...
if (function_exists('register_sidebar')) {
	register_sidebar(array(
		...
		'id'   => 'default-sidebar',
		'description'   => __( 'These widgets appear in the sidebar of all pages (depending on settings in the theme options)', 'itb' ),
		'before_widget' => '<div class="widget-wrapper"><div class="widget">',
		'after_widget'  => '</div></div>',
		'before_title'  => '<div class="section-wrapper"><div class="section">',
		'after_title'   => '</div></div>'
...
if (function_exists('register_sidebar')) {
	register_sidebar(array(
		'name' => 'Page Sidebar',
		'id'   => 'page-sidebar',
		'description'   => __( 'These widgets appear in the sidebar of all regular pages (depending on settings in the theme options)', 'itb' ),
		'before_widget' => '<div class="widget-wrapper"><div class="widget">',
		'after_widget'  => '</div></div>',
		'before_title'  => '<div class="section-wrapper"><div class="section">',
		'after_title'   => '</div></div>'
...
if (function_exists('register_sidebar')) {
	register_sidebar(array(
		...
		'id'   => 'archive-sidebar',
		'description'   => __( 'These widgets appear in the sidebar of all category/archive/tag listing pages (but not review listings)', 'itb' ),
		'before_widget' => '<div class="widget-wrapper"><div class="widget">',
		'after_widget'  => '</div></div>',
		'before_title'  => '<div class="section-wrapper"><div class="section">',
		'after_title'   => '</div></div>'
...
if (function_exists('register_sidebar')) {
	register_sidebar(array(
		'name' => 'Search Sidebar',
		'id'   => 'search-sidebar',
		'description'   => __( 'These widgets appear in the sidebar of all search listing pages', 'itb' ),
		'before_widget' => '<div class="widget-wrapper"><div class="widget">',
		'after_widget'  => '</div></div>',
		'before_title'  => '<div class="section-wrapper"><div class="section">',
		'after_title'   => '</div></div>'
...
if (function_exists('register_sidebar')) {
	register_sidebar(array(
		'name' => 'Author Sidebar',
		'id'   => 'author-sidebar',
		'description'   => __( 'These widgets appear in the sidebar of the author listing template page', 'itb' ),
		'before_widget' => '<div class="widget-wrapper"><div class="widget">',
		'after_widget'  => '</div></div>',
		'before_title'  => '<div class="section-wrapper"><div class="section">',
		'after_title'   => '</div></div>'
...
if (function_exists('register_sidebar')) {
	register_sidebar(array(
		'name' => 'Footer Panel 1',
		'id'   => 'footer-panel-1',
		'description'   => __( 'These widgets appear in the first footer panel', 'itb' ),
		'before_widget' => '<div class="widget">',
		'after_widget'  => '</div>',
		'before_title'  => '<h2>',
		'after_title'   => '</h2>'
...
if (function_exists('register_sidebar')) {
	register_sidebar(array(
		'name' => 'Footer Panel 2',
		'id'   => 'footer-panel-2',
		'description'   => __( 'These widgets appear in the second footer panel', 'itb' ),
		'before_widget' => '<div class="widget">',
		'after_widget'  => '</div>',
		'before_title'  => '<h2>',
		'after_title'   => '</h2>'
...
if (function_exists('register_sidebar')) {
	register_sidebar(array(
		'name' => 'Footer Panel 3',
		'id'   => 'footer-panel-3',
		'description'   => __( 'These widgets appear in the third footer panel', 'itb' ),
		'before_widget' => '<div class="widget">',
		'after_widget'  => '</div>',
		'before_title'  => '<h2>',
		'after_title'   => '</h2>'
...
if (function_exists('register_sidebar')) {
	register_sidebar(array(
		'name' => 'Footer Panel 4',
		'id'   => 'footer-panel-4',
		'description'   => __( 'These widgets appear in the fourth footer panel', 'itb' ),
		'before_widget' => '<div class="widget">',
		'after_widget'  => '</div>',
		'before_title'  => '<h2>',
		'after_title'   => '</h2>'
...
if (function_exists('register_sidebar')) {
	register_sidebar(array(
		'name' => 'Footer Credits',
		'id'   => 'footer-credits',
		'description'   => __( 'The small credit text area at the very bottom right-hand side of the footer', 'itb' ),
		'before_widget' => '',
		'after_widget'  => '',
		'before_title'  => '',
		'after_title'   => ''
...
class oswc_latest_tweets extends WP_Widget {
	function oswc_latest_tweets() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'Extended: Latest Tweets', 'description' => __( 'Displays your latest Tweets','itb') );
	...
	function form( $instance ) {
        ...
        <p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:','itb'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'num' ); ?>"><?php _e( 'Number of Tweets:','itb'); ?></label>
        ...
        <p>
			<label for="<?php echo $this->get_field_id( 'refresh' ); ?>"><?php _e( 'Refresh every','itb'); ?></label>
            ...
            <?php _e( 'seconds','itb'); ?>
            <p><em><?php _e( 'Only refreshes your tweets, not the page.','itb'); ?></em></p>            
		</p>
        
        <p>
			<label for="<?php echo $this->get_field_id( 'text_default' ); ?>"><?php _e( 'Regular Tweet Prefix:','itb'); ?></label>
            ...
            <p><em><?php _e( 'Example: about 2 hours ago','itb'); ?>&nbsp;<b><?php _e( 'we said,','itb'); ?></b>&nbsp;<?php _e( 'what is your favorite comedy duo on Youtube?','itb'); ?></em></p>  
		</p>
        
        <p>
			<label for="<?php echo $this->get_field_id( 'text_ed' ); ?>"><?php _e( 'Past Tense Prefix:','itb'); ?></label>
            ...
            <p><em><?php _e( 'Example: about 4 hours ago','itb'); ?>&nbsp;<b><?php _e( 'we','itb'); ?></b>&nbsp;<?php _e( 'bought Modern Warfare 3 at the nearest Best Buy.','itb'); ?></em></p>
		</p>
        
        <p>
			<label for="<?php echo $this->get_field_id( 'text_ing' ); ?>"><?php _e( 'Present Tense Prefix:','itb'); ?></label>
            ...
            <p><em><?php _e( 'Example: about 7 minutes ago','itb'); ?>&nbsp;<b><?php _e( 'we were','itb'); ?></b>&nbsp;<?php _e( 'drinking a pint of Bells Consecrator Doppelbock.','itb'); ?></em></p>
		</p>
        
        <p>
			<label for="<?php echo $this->get_field_id( 'text_reply' ); ?>"><?php _e( 'Reply Prefix:','itb'); ?></label>
            ...
            <p><em><?php _e( 'Example: about 2 hours ago','itb'); ?>&nbsp;<b><?php _e( 'we replied','itb'); ?></b>&nbsp;<?php _e( '@wordpress thank you for your magnanimosity.','itb'); ?></em></p>
		</p>
        
        <p>
			<label for="<?php echo $this->get_field_id( 'text_url' ); ?>"><?php _e( 'URL Prefix:','itb'); ?></label>
            ...
            <p><em><?php _e( 'Example: about 45 minutes ago','itb'); ?>&nbsp;<b><?php _e( 'we were checking out','itb'); ?></b>&nbsp;<?php _e( 'Dubstep meets guns: http://youtu.be/hDlif8Km4S4','itb'); ?></em></p>
		</p>
        
        <p><em><?php _e( 'See the Made documentation for further information.','itb'); ?></em></p>
...
class oswc_flickr extends WP_Widget {
	function oswc_flickr() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'Extended: Flickr Feed', 'description' => __( 'Displays your Flickr feed','itb') );
		/* Widget control settings. */
	...
	function widget( $args, $instance ) {
		...
		if ( $num ) { ?>
			...
			<div class="flickr"> 
                ...
                <a class="more" href="http://www.flickr.com/photos/<?php echo $oswc_flickr_name; ?>" target="_blank"><?php _e( 'View more photos', 'itb' ); ?> &raquo;</a>
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'num' ); ?>"><?php _e( 'Number of photos:','itb'); ?></label>
			<input id="<?php echo $this->get_field_id( 'num' ); ?>" name="<?php echo $this->get_field_name( 'num' ); ?>" value="<?php echo $instance['num']; ?>" style="width:40px" />
		</p>
...
class oswc_tabbed_posts extends WP_Widget {
	function oswc_tabbed_posts() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'Extended: Post Tabs', 'description' => __( 'Displays posts, comments, and tags in a jQuery tabbed format','itb') );
		/* Widget control settings. */
	...
	function widget( $args, $instance ) {
        ...
        <div id="tabbed-posts" class="complex-list<?php if($thumbsize=="footer-thumbnail") { ?> small<?php } ?>">
            <ul class="tabnav">
				<?php if($showpopular) { ?><li><a class="first" href="#tabs-popular"><?php _e('Popular','itb'); ?></a></li><?php } ?>
                <?php if($showrecent) { ?><li><a href="#tabs-recent"><?php _e('Recent','itb'); ?></a></li><?php } ?>
                
                <?php if($showtags) { ?><li><a href="#tabs-tags"><?php _e('Tags','itb'); ?></a></li><?php } ?>
            </ul>
            <br class="clearer" />
	...
	function form( $instance ) {
        ...
        <p>
			...
			<?php _e( 'Order tags by name','itb'); ?><br />
			...
			<?php _e( 'Order tags by post count','itb'); ?>
		</p>
...
class oswc_tabbed_archives extends WP_Widget {
	function oswc_tabbed_archives() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'Extended: Page & Archive Tabs', 'description' => __( 'Displays pages, categories, and archives in a jQuery tabbed format','itb') );
		/* Widget control settings. */
	...
	function widget( $args, $instance ) {
        ...
        <div id="tabbed-archives" class="simple-list">
            <ul class="tabnav">
				<?php if($showcategories) { ?><li><a class="first" href="#tabs-categories"><?php _e('Categories','itb'); ?></a></li><?php } ?>
                <?php if($showpages) { ?><li><a href="#tabs-pages"><?php _e('Pages','itb'); ?></a></li><?php } ?>
                <?php if($showarchives) { ?><li><a href="#tabs-archives"><?php _e('Archives','itb'); ?></a></li><?php } ?>
            </ul>
            <br class="clearer" />
            <div class="tabdiv-wrapper">
...
if($typecount>0) {
	class oswc_tabbed_reviews extends WP_Widget {
		function oswc_tabbed_reviews() {
			/* Widget settings. */
			$widget_ops = array( 'classname' => 'Extended: Review Category Tabs', 'description' => __( 'Displays review categories in a jQuery tabbed format','itb') );
			/* Widget control settings. */
		...
		function widget( $args, $instance ) {
			...
			<div id="tabbed-<?php echo $reviewtype; ?>-reviews" class="simple-list review-cats">
            	...
            	<div class="review-header"><?php echo $posttypename; ?><?php _e( ' by category', 'itb' ); ?></div>
...
if($typecount>0) {
	class oswc_tabbed_latest_reviews extends WP_Widget {
		function oswc_tabbed_latest_reviews() {
			/* Widget settings. */
			$widget_ops = array( 'classname' => 'Extended: Latest Review Tabs', 'description' => __( 'Displays recent reviews in a jQuery tabbed format with either large or small thumbnails','itb') );
			/* Widget control settings. */
				...
				<?php foreach($oswcPostTypes->postTypes as $postType){ 
					...
					<div id="tabs-<?php echo $postType->id; ?>-<?php echo $sort; ?>" class="tabdiv">
						<ul>
	                        ...
	                        <li class="more" title="View all <?php echo $reviewType->name; ?> reviews"><a href="<?php echo $reviewType->more_link; ?>"><?php _e( 'More','itb'); ?></a></li>
                            <li class="last">&nbsp;</li>
            ...
            foreach($oswcPostTypes->postTypes as $postType){
            	if($postType->enabled) { ?>
	                <p>
	                    ...
	                    <?php echo $postType->name ?> <?php _e( 'reviews','itb'); ?>                   
...
if($typecount>0) {
	class oswc_tabbed_latest_reviews_compact extends WP_Widget {
		function oswc_tabbed_latest_reviews_compact() {
			/* Widget settings. */
			$widget_ops = array( 'classname' => 'Extended: Latest Review Tabs Compact', 'description' => __( 'Displays recent reviews in a jQuery tabbed format without thumbnails in a more compact fashion so you can fit more on the page at once.','itb') );
			/* Widget control settings. */
...
if($typecount>0) {
	class oswc_latest_reviews extends WP_Widget {
		function oswc_latest_reviews() {
			/* Widget settings. */
			$widget_ops = array( 'classname' => 'Extended: Latest Reviews', 'description' => __( 'Displays recent reviews from a single review type. Add multiple widgets for each review type','itb') );
			/* Widget control settings. */
				...
				if ( $title ) { ?>                	
					<?php echo $before_title; ?>
                    	...
                    	<?php if($reviewtype!="All Reviews") { ?>
                    		...
                    		<a class="more" href="<?php echo $postType->more_link ?>" title="<?php _e('View all ','itb'); ?><?php echo $postType->name; ?><?php _e(' reviews','itb'); ?>">&nbsp;</a>
		...
		function form( $instance ) {
            ...
            <p>
				<?php _e( 'Review Type:','itb'); ?>
				<select name="<?php echo $this->get_field_name( 'reviewtype' ); ?>">
                	<option<?php if($instance['reviewtype']=='All Reviews') { ?> selected<?php } ?> value="<?php _e( 'All Reviews', 'itb' ); ?>"><?php _e( 'All Reviews', 'itb' ); ?></option>
		            <?php 
		            foreach($oswcPostTypes->postTypes as $postType){
		            	if($postType->enabled) { ?>
...
class oswc_unwrapped extends WP_Widget {
	function oswc_unwrapped() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'Extended: Unwrapped Text', 'description' => __( 'Displays arbritrary text of HTML just like the standard Text widget, but this one does not include the header bar and wrapper style - just a blank canvas for content','itb') );
		/* Widget control settings. */
	...
	function form( $instance ) {
        ...
        <p>
			<label for="<?php echo $this->get_field_id( 'text' ); ?>"><?php _e( 'Text/HTML','itb'); ?></label><br />
...
class oswc_ad_125 extends WP_Widget {
	function oswc_ad_125() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'Extended: Ad Block', 'description' => __( 'Insert your adsense or HTML code for four 125px-wide ads that will display in a 2 x 2 panel (if this widget is put into a footer panel, the maximum width of the ads is 90px instead of 125px)','itb') );
		/* Widget control settings. */
	...
	function form( $instance ) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:','itb'); ?></label>
            <input id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" value="<?php echo $instance['title']; ?>" style="width:160px" />
            <p><em><?php _e( 'Leave the title blank to hide the entire title bar.','itb'); ?></em></p>
        </p>
        
        <p>
			<label for="<?php echo $this->get_field_id( 'ad1' ); ?>"><?php _e( 'Ad 1 HTML:','itb'); ?></label><br />
        ...
        <p>
			<label for="<?php echo $this->get_field_id( 'ad2' ); ?>"><?php _e( 'Ad 2 HTML:','itb'); ?></label><br />
        ...
        <p>
			<label for="<?php echo $this->get_field_id( 'ad3' ); ?>"><?php _e( 'Ad 3 HTML:','itb'); ?></label><br />
        ...
        <p>
			<label for="<?php echo $this->get_field_id( 'ad4' ); ?>"><?php _e( 'Ad 4 HTML:','itb'); ?></label><br />
        ...
        <p><em><?php _e( 'Tip: you can add as many of these widgets as you want in order to create multiple ad panels on top of each other. Also, the width crops at 125px but the height does not crop, so you can use images of any height.','itb'); ?></em></p>        
        <?php
	}
}
...
class oswc_email_subscribe extends WP_Widget {
	function oswc_email_subscribe() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'Extended: Email Subscribe', 'description' => __( 'Displays a form for users to subscribe to your Feedburner feed via email','itb') );
		/* Widget control settings. */
	...
	function widget( $args, $instance ) {
        ...
        <div class="signup">
            ...
            <form id="feedburner_subscribe" class="subscribe" action="http://feedburner.google.com/fb/a/mailverify" method="post" target="popupwindow" onsubmit="window.open('http://feedburner.google.com/fb/a/mailverify?uri=<?php echo $oswc_feedburner; ?>', 'popupwindow', 'scrollbars=yes,width=550,height=520');return true">
                ...
                <input type="image" src="<?php echo get_template_directory_uri(); ?>/images/signup.png" class="btn" title="<?php _e('You will receive a daily email with new content from our website.','itb'); ?>" onclick="document.feedburner_subscribe.submit();" />
	...
	function form( $instance ) {
        ...
        <p>
			<label for="<?php echo $this->get_field_id( 'label' ); ?>"><?php _e( 'Textbox Label:','itb'); ?></label>
