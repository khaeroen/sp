...
if($oswc_latest_type=="tag") {
	...
	if(empty($terms)) $slidererror = __("The tag you specified in the theme options for the Latest Slider does not match a tag slug in your database.","itb");
	...
	if(empty($terms)) $slidererror = __("The category you specified in the theme options for the Latest Slider does not match a category slug in your database.","itb");
	...
	if($thisReviewSlug=='') $slidererror = __("The review type you specified in the theme options for one of the review types in your Latest Slider doesn't match a review type in your database.","itb");
} else {
