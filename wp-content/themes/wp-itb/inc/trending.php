...
if($oswc_trending_type=="tag") {
	...
	if(empty($terms)) $slidererror = __("The tag you specified in the theme options for the Trending Slider does not match a tag in your database.","itb");
	...
	if(empty($terms)) $slidererror = __("The category you specified in the theme options for the Trending Slider does not match a category in your database.","itb");
	$termslug = $terms[0]->slug; //get the slug
