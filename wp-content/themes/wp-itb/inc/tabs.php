        ...
        foreach ($cats as $catname) { //loop through each latest category
            ...
            if($catname!="") {
                ...
                if($oswc_tabs_type=="tag") {
                    ...
                    if(empty($terms)) $slidererror = __("You specified '$catname' for one of the tags in your Front Page Tabs, which doesn't match a tag in your database.","itb");
                    ...
                    if(empty($terms)) $slidererror = __("You specified '$catname' for one of the categories in your Front Page Tabs, which doesn't match a category in your database.","itb");
                } else {
					...
					if($reviewSlug=='') $slidererror = __("You specified '$catname' for one of the review types in your Front Page Tabs, which doesn't match a review type in your database.","itb");
                }
				?>
