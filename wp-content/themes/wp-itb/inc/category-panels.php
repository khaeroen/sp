        ...
        foreach ($cats as $cat) { //loop through each latest category
            ...
            if($catname!="") {
                ...
                if($oswc_categorypanels_type=="tag") {
                    ...
                    if(empty($terms)) $slidererror = __("You specified '$catname' for one of the tags in your Category Panels, which doesn't match a tag in your database.","itb");
                    ...
                    if(empty($terms)) $slidererror = __("You specified '$catname' for one of the categories in your Category Panels, which doesn't match a category in your database.","itb");
                    $termslug = $terms[0]->slug; //get the slug
                                ...
                                <div class="vertical"> 
                                    ...
                                    <div class="inner">   
										...
										<div class="more-bar">
                                            ...
                                            <div class="more"><a href="<?php the_permalink(); ?>"><?php _e('','itb'); ?></a></div>
