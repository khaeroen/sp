...
if($oswc_dontmiss_type=="tag") {
	...
	if(empty($terms)) $slidererror = __("The tag you specified in the theme options for the Don't Miss Slider does not match a tag slug in your database.","itb");
	...
	if(empty($terms)) $slidererror = __("The category you specified in the theme options for the Don't Miss Slider does not match a category slug in your database.","itb");
	$termslug = $terms[0]->slug; //get the slug
	...
	if($thisReviewSlug=='') $slidererror = __("The review type you specified in the theme options for the Don't Miss Slider does not match a review type in your database.","itb");
} else {
