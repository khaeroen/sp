                ...
                <div id="logo-wrapper">
                    ...
                    <div id="logo"><!--logo and section header area-->
                            ...
                            <a href="<?php echo home_url(); ?>/">
                                <img id="site-logo" alt="<?php bloginfo('name'); ?>" style="float:left" src="<?php echo $oswc_logo; ?>" />
                                <img id="site-logo-iphone" alt="<?php bloginfo('name'); ?>" style="float:left" src="<?php echo $oswc_logo_iphone; ?>" />
                                <img id="site-logo-ipad" alt="<?php bloginfo('name'); ?>" style="float:left" src="<?php echo $oswc_logo_ipad; ?>" />
                            </a>
