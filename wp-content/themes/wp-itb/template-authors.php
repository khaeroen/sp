                ...
                <div id="authorbox" class="categorypanel<?php if($postcount % 2 == 0) { ?> right<?php } ?>"> 
                    ...
                    <div class="inner">                      
                        ...
                        <ul class="social-links">
                            ...
                            <li class="twitter"><a title="<?php _e( 'Twitter', 'itb' ); ?>" href='http://twitter.com/<?php the_author_meta('twitter', $author->post_author); ?>'>&nbsp;</a></li>
                            <?php endif; ?>
                            <?php if(get_the_author_meta('facebook', $author->post_author)): ?>
                            <li class="facebook"><a title="<?php _e( 'Facebook', 'itb' ); ?>" href='http://www.facebook.com/<?php the_author_meta('facebook', $author->post_author); ?>'>&nbsp;</a></li>
                            <?php endif; ?>
                            <?php if(get_the_author_meta('linkedin', $author->post_author)): ?>
                            <li class="linkedin"><a title="<?php _e( 'LinkedIn', 'itb' ); ?>" href='http://www.linkedin.com/in/<?php the_author_meta('linkedin', $author->post_author); ?>'>&nbsp;</a></li>
                            <?php endif; ?>
                            <?php if(get_the_author_meta('googleplus', $author->post_author)): ?>
                            <li class="googleplus"><a title="<?php _e( 'Google+', 'itb' ); ?>" href='http://plus.google.com/<?php the_author_meta('googleplus', $author->post_author); ?>'>&nbsp;</a></li>
                            <?php endif; ?>
                            <?php if(get_the_author_meta('youtube', $author->post_author)): ?>
                            <li class="youtube"><a title="<?php _e( 'YouTube', 'itb' ); ?>" href='http://www.youtube.com/user/<?php the_author_meta('youtube', $author->post_author, $author->post_author); ?>/'>&nbsp;</a></li>
                            <?php endif; ?>
                            <?php if(get_the_author_meta('flickr', $author->post_author)): ?>
                            <li class="flickr"><a title="<?php _e( 'Flickr', 'itb' ); ?>" href='http://www.flickr.com/photos/<?php the_author_meta('flickr', $author->post_author, $author->post_author); ?>/'>&nbsp;</a></li>
                            <?php endif; ?>
                            <?php if(get_the_author_meta('digg', $author->post_author)): ?>
                            <li class="digg"><a title="<?php _e( 'Digg', 'itb' ); ?>" href='http://digg.com/users/<?php the_author_meta('digg', $author->post_author); ?>'>&nbsp;</a></li>
                            <?php endif; ?>
                            <?php if(get_the_author_meta('user_email', $author->post_author)): ?>
                            <li class="email"><a title="<?php _e( 'Email', 'itb' ); ?>" href='mailto:<?php the_author_meta('user_email', $author->post_author); ?>'>&nbsp;</a></li>
                            <?php endif; ?>
                            <?php if(get_the_author_meta('user_url', $author->post_author)): ?>
                            <li class="url"><a title="<?php _e( 'Website', 'itb' ); ?>" href='<?php the_author_meta('user_url', $author->post_author); ?>'>&nbsp;</a></li>
                            <?php endif; ?>                     
                        </ul>
                        ...
                        <div class="more-articles">
                            ...
                            ?>
                                <?php _e( 'Latest: ', 'itb' ); ?><a href='<?php the_permalink();?>'><?php the_title(); ?></a>
                            <?php endwhile; ?>
        ...
        <div class="widget-wrapper">
        	...
        	<div class="widget">
                ...
                <div class="section-wrapper"><div class="section">
                    ...
                    <?php _e(' Program Magister Studi Pembangunan  ', 'itb' ); ?>
                
                </div></div> 
                
                <div class="textwidget">  
                                              
                	<p><?php _e( 'Menyediakan layanan pendidikan yang unggul (excellent) untuk pengembangan kemampuan kognitif, afektif, serta ketrampilan peserta didik, sehingga dapat berperan kritis, konstruktif dalam wacana pembangunan, serta berperan kreatif dan inovatif dalam praksis pembangunan', 'itb' ); ?></p>
