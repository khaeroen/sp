...
define( 'NOTIFIER_THEME_FOLDER_NAME', 'itb' ); // The theme folder name
define( 'NOTIFIER_XML_FILE', 'http://itb.ac.id' ); // The remote notifier XML file containing the latest version of the theme and changelog
