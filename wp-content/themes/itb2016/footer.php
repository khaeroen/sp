				...
				<div class="pad group">
					...
					<div class="grid one-half">
						...
						<div id="copyright">
							...
							<?php else: ?>
								<p><!--<?php bloginfo(); ?>--><a href="http://itb.ac.id"><img src="<?php echo get_site_url()?>/wp-content/themes/itb2016/img/itb.png" style="height:35px;margin-right:5px;vertical-align:middle;">Institut Teknologi Bandung</a> &copy; <?php echo date( 'Y' ); ?>. <?php _e( 'All Rights Reserved.', 'hueman' ); ?></p>
							<?php endif; ?>
						</div><!--/#copyright-->
